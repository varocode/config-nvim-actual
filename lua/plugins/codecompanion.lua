...
return {
	...
	-- 		"nvim-telescope/telescope.nvim", -- For telescope provider, file or buffer picker
	-- 		"hrsh7th/nvim-cmp", -- For nvim-cmp provider, file or buffer picker
	-- 	},
	-- 	opts = {
	-- 		strategies = {
	-- 			chat = {
	-- 				adapter = "copilot",
	-- 				roles = { llm = "  Copilot Chat", user = "varocode" },
	-- 				slash_commands = {
	-- 					["buffer"] = {
